...
export const shippingAddressSchema = z.object({
    ...
    streetAddress: z.string().min(3, 'Address must be atleast 3 characters long'),
    city: z.string().min(3, 'City must be atleast 3 characters long'),
    postalCode: z.string().min(3, 'Postal code must be atleast 3 characters long'),
...
export const insertReviewSchema = z.object({
    title: z.string().min(3, 'Title must be at leaast 3 characters'),
    description: z.string().min(3, 'Description must be at leaast 3 characters'),
    productId: z.string().min(1, 'ProductId is required'),
    useId: z.string().min(1, 'UserId is required'),
    rating: z.coerce
        .number()
        .int()
